...
//       <button
//         onClick={toggleRefresh}
//         className="bg-red-500 hover:bg-red-600 w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition duration-300"
//       >
//         <DislikeButton playerIdToDislike={player.player_id} />
//       </button>
//       <div className="bg-blue-500 hover:bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition duration-300">
...
//       <button
//         onClick={toggleRefresh}
//         className="bg-green-500 hover:bg-green-600 w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition duration-300"
//       >
//         <LikeButton playerIdTolike={player.player_id} />
//       </button>
//     </div>

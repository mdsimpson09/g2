...
//         <h3 className="text-3xl sm:text-3xl md:text-4xl lg:text-4xl text-center mb-2 font-semi-bold navfont ml-8 md:-mb-12 lg:mb-10 sm:-mb-8 sm:mt-8 sm:-ml-4"> Getting Started </h3>
//         <img className=" h-[30vh] -mt-24 object-cover ml-2 md:-ml-6 sm:w-auto w-[35%] lg:w-[45vh] md:w-[35vh] -mb-14 sm:-mb-20 sm:-ml-10  md:-mb-12 lg:-mb-10 lg:ml-2" src="/5.png" alt="logo" />
...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-pink-500 text-gray-100 p-4 sm:p-8">
      <div className="max-w-7xl mx-auto bg-gray-900 p-8 rounded-lg shadow-xl">
        <section className="about-section">
          <h3 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500 text-center mb-8 navfont">
            About Gamer Date
          </h3>
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-gray-300">
            <p>
              Welcome to Gamer Date, where gamers can connect, play, and build meaningful relationships.
            </p>
            <br />
            <p>
              We strive to provide you with the best opportunities to meet and connect with other gamers above the age of 18. Say goodbye to the days where your team is filled with children.
        ...
        <section className="getting-started-section my-12">
          <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 text-center mb-8 navfont">
            Getting Started
          </h3>
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-gray-300">
            <ul className="list-decimal ml-4">
        ...
        <section className="endorsements-section my-12">
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400 text-center mb-8 navfont">
            What Gamers are Saying
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg text-gray-300">
              <p className="font-semibold text-pink-400">EpicRogueQueen</p>
              <p>&quot;Gamer Date is a game-changer! It&apos;s been amazing for finding my squad. We&apos;ve been dominating leaderboards ever since. Big shoutout to Gamer Date for making this possible!&quot;</p>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg text-gray-300">
              <p className="font-semibold text-blue-400">PixelPaladin42</p>
              <p>&quot;Never knew how many like-minded gamers were out there until I joined Gamer Date. I&apos;ve built so many incredible friendships and even found my perfect duo partner for co-op campaigns. Highly recommend it to any gamer looking to expand their network!&quot;</p>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg md:col-span-2 text-gray-300">
              <p className="font-semibold text-purple-400">MysticMage88</p>
              <p>&quot;As someone who always struggled to find a reliable team for competitive play, Gamer Date has been a lifesaver. It&apos;s like a social network but just for gamers. I&apos;ve met some awesome people, and our team synergy is off the charts!&quot;</p>
            </div>
          </div>
        </section>

        <section className="how-it-works-section my-12">
          <h4 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400 text-center mb-4 navfont">
            Contact Us
          </h4>
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-gray-300">
            <p className="mb-4">
            ...
            <p className="mb-4">
              Fill out our online <Link href="/contact" className="font-bold text-indigo-400 hover:underline">contact form</Link>, and one of our staff members will get back to you as soon as possible.
            </p>
          </div>
          <p className="text-center mt-6">
            Be sure to read the <Link href="/faqs" className="font-bold text-pink-400 hover:underline">Community Standards</Link>.
          </p>
        </section>
      </div>
    </div>
